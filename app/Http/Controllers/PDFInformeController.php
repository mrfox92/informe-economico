...
class PDFInformeController extends Controller
{
    public $data;
    ...
    */
    public function exportPDF( Request $request )
    {
        ...
        $this->init_month = $request->input('init_month');
        $this->init_year = $request->input('init_year');
        $this->limit_month = $request->input('limit_month');
        $this->limit_year = $request->input('limit_year');
        ...
        $nombre_informe_economico_pdf = 'informe-economico-desde-'. $init_month_name .'-'. $this->init_year . '-a-'. $limit_month_name .'-'. $this->limit_year;
        //  to uppercase
        $nombre_informe_economico_pdf = strtoupper( $nombre_informe_economico_pdf );
        //  titulo cabecera
        $titulo = 'informe economico desde '. $init_month_name .' '. $this->init_year . ' a '. $limit_month_name .' '. $this->limit_year;
        //  titulo pie informe
        $titulo_pie_informe = 'Resumen anual '. $this->init_year . ' - ' . $this->limit_year;
        //  nombre encargado
        $nombre_encargado = 'Jorge Fernandez';
        //  cargo
        $cargo = 'Pastor iglesia pentecostal chile austral';
        //  formato excel
        $nombre_informe_economico_pdf .= '.pdf';
        
        $pdf = \PDF::loadView('exports.informe-economico-pdf', [
            'titulo'                    =>  $titulo,
            'titulo_pie_informe'        =>  $titulo_pie_informe,
        ...
        return $pdf->download($nombre_informe_economico_pdf);
    }
}
